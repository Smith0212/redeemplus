const { validateJoi, checkAdminToken } = require("../../middleware")
...
// Dashboard Stats
router.post("/dashboard/stats", checkAdminToken, adminModel.getDashboardStats)
...
router.post("/memberships", checkAdminToken, adminModel.getMembershipPlans)
