  ...
  async updateProfile(req, res) {
    try {
      ...
      const updateQuery = `
                ...
                RETURNING id, username, email, phone, country_code, profile_image
            `
      ...
      return sendResponse(req, res, 200, responseCode.SUCCESS, { keyword: "profile_updated" }, result.rows[0])
    } catch (err) {
